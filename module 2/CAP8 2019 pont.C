...
ponteiro e' este seu pedaco de papel. Ele tem anotado um endere�o. Qual e' o
...
eles indicam locais cujos conteudos s�o diferentes. Entao os dois enderecos sao
...
endereco de memoria onde esta' armazenada a vari�vel "f".
...
que tipo de vari�vel vamos aponta'-lo. Um ponteiro int aponta para uma variavel
do tipo inteira, isto �, guarda o endere�o de um inteiro.
...
por meio de um ponteiro e' t�o comum, que um operador especial foi definido pela
linguagem C para realiza esta tarefa. Ele � o operador seta "->". Este operador
...
que o ponteiro leva em conta o tipo de variavel apontada, entao esta express�o
