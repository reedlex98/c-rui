...
O acesso a um arquivo e' interrompido por meio de uma opera��o de fechamento.
...
ponteiro de arquivo. Este � um ponteiro para uma area na memoria(buffer) onde
...
Para declarar uma variavel ponteiro de arquivo, usa-se o seguinte formato:
    ...
    FILE *p1;  -> "p1" � uma variavel ponteiro de arquivo do tipo "FILE"
...
2 - Fa�a um programa para gerenciar uma agenda de contatos. Para cada contato 
    armazene o nome, o telefone e o anivers�rio (dia e m�s). O programa deve ter 
    as op��es:
    1 - inserir contato,
    2 - remover contato, 
    ...
    6 - imprimir os aniversariantes do m�s. 
...
3 - Implemente um controle simples de mercadorias em uma despensa dom�stica.
    ...
    5 - listar os produtos n�o dispon�veis.
